...
class TableAdhesion extends Component {
    state = {
        data: [],
        IsVisibletable: true,
        intermmediare: {
    ...
    constructor() {
        ...
        AdminService.GetDemandesUsers('inactive').then(result => {
                        ...
                        <div class="container emp-profile">
                                ...
                                <div class="row">
                                    <div class="tab-pane fade show active col-md-5" id="home" role="tabpanel">
                                        ...
                                        <div class="row">
                                            <button class="btn btn-success col-md-3 " onClick={() => this.ChangeStatus(this.state.intermmediare.id_user, 'active')}>Valider</button>
                                            <button class="btn btn-danger col-md-3 offset-md-1" onClick={() => this.ChangeStatus(this.state.intermmediare.id_user, 'desactivated')}>Refuser</button>
                                            <button class="btn btn-warning col-md-3 offset-md-1" onClick={() => this.Annuler()}>Annuler</button>
